...
const ContactUs = () => {
  return (
    <div className="pb-30">
      <div className="px-4 min-h-screen flex items-center justify-center p-2">
        <div className="max-w-6xl mx-auto relative">
          <div className="grid lg:grid-cols-3 items-center gap-y-12">
            <div className="grid grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
              <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-primary border-2 border-white [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)]">
                <svg
                ...
                <h4 className="text-neutral-content text-sm font-semibold mt-4">
                  Visit office
                </h4>
              ...
              <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-primary border-2 border-white [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)]">
                ...
                <p className="text-xs text-slate-600 mt-1.5">+158 996 888</p>
              </div>
              <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-primary border-2 border-white [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-primary border-2 border-white [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)]">
                ...
                <p className="text-xs text-slate-600 mt-1.5">+1-548-2588</p>
              </div>
            </div>

            <div className="lg:col-span-2 bg-[#0c1425] rounded-lg sm:p-10 p-6 z-10 max-lg:-order-1">
              <h2 className="text-3xl text-neutral-content text-center font-semibold mb-8">
                Contact us
              </h2>
              <form>
                <div className="max-w-md mx-auto space-y-3">
                  <input
                    type="text"
                    placeholder="Name"
                    className="w-full bg-[#0c1425] rounded-md py-3 px-4 text-sm border border-gray-300 focus:border-gray-600 outline-none"
                  />
                  <input
                    type="email"
                    placeholder="Email"
                  ...
                  <textarea
                    placeholder="Message"
                    rows="6"
                    className="w-full bg-[#0c1425] rounded-md px-4 text-sm pt-3 border border-gray-300 focus:border-gray-600 outline-none"></textarea>
                  <button
                    type="button"
                    className="text-white w-full relative bg-black hover:bg-[#111] rounded-md text-sm px-6 py-3 cursor-pointer mt-2!">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16px"
                      height="16px"
